...
function Collection({ onAddToCart, cartItems, onNavigate }) {
  // Tracks which product category filter is currently active.
  const [activeFilter, setActiveFilter] = useState('all')

  // Builds the visible product list based on the selected filter.
  ...
  // Main render for the standalone collections page.
  return (
    <main className="mx-auto w-full max-w-[1280px] px-6 pt-[12vh] sm:px-10 lg:px-16">
      {/* Hero section introducing the collections page and back-to-home action. */}
      ...
      {/* Editorial gallery section showing soft-focus collection imagery. */}
      ...
      {/* Featured necklace section highlighting a separate product story area. */}
      ...
      {/* Filterable product grid section for browsing collection items by category. */}
      <section className="border-x border-b border-stone-200 bg-white px-6 py-8 lg:px-12 lg:py-10">
